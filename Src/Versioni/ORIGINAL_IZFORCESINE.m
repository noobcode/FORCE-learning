function [AverageFiringRate, AverageError] = ORIGINAL_IZFORCESINE
...
dt = 0.2;%0.04;%0.04; %Integration time step in ms 
...
tspike = zeros(20*nt,2);  %If you want to store spike times, 

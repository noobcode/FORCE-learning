function [zx1_new, zx2_new, zx3_new, zx4_new, target_length] = load_four_trajectories_same_length(dt)
    [~, zx1, t_stamps1, T1] = load_trajectory('trajectory_1.csv', dt, 1, false);
    [~, zx2, t_stamps2, T2] = load_trajectory('trajectory_2.csv', dt, 1, false);
    [~, zx3, t_stamps3, T3] = load_trajectory('trajectory_3.csv', dt, 1, false);
    [~, zx4, t_stamps4, T4] = load_trajectory('trajectory_4.csv', dt, 1, false);
